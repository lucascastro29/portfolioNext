...
const CONTACT_EMAIL = "lucascastro2929@gmail.com";
...
const Forms = (props: FormsModel) => {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const from = (formData.get("from_name") as string) || "";
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className="col-10 container border rounded border-gray-200 shadow"
            style={{ margin: "15px", backgroundColor: "rgb(30 30 35)" }}
          >
            <Form
              style={{ textAlign: "start", padding: "5px", height: "260px" }}
              onSubmit={handleSubmit}
            >
              <Form.Group className="mb-3">
                <Form.Label htmlFor="from_name">{props.form1}</Form.Label>
                <Form.Control
                  type="email"
                  required
                  id="from_name"
                  name="from_name"
                  aria-label={props.form1}
                  style={{
              ...
              <Form.Group className="mb-3">
                <Form.Label htmlFor="message">{props.form2}</Form.Label>
                <Form.Control
                  as="textarea"
                  id="message"
                  name="message"
                  required
                  aria-label={props.form2}
                  style={{
                    backgroundColor: "#30373e",
                    border: "none",
                    color: "white",
              ...
              {sent && (
                ...
                >
                  ✓ {props.sentMessage || "Abriendo tu cliente de email..."}
                </p>
              )}
            </Form>
          </div>
        ...
        <div className="col-md-5 col-12" style={{ marginBottom: "30px" }}>
          ...
          >
            <div className="col-12 d-row justify-content-center">
              <div
                className="col-12 d-flex"

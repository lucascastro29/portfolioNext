            ...
            <div className={style.container1}>
              <div className="col-12 col-sm-12">
                ...
                <div className="col-12 col-sm-12 user-select-none">
                  <div className={style.h1}>{props.textpresentation}</div>
                </div>
                <div
                  className="col-12 d-column justify-content-end"
                  style={{
                    position: "relative",
                    top: 0,
                    bottom: 0,
                ...
                >
                  <div
                    className="col-12 d-row justify-content-end"
                    style={{
                      position: "absolute",
                      top: "0px",
                      bottom: "0px",
                  ...
                  >
                    <div
                      style={{ height: "15px", marginTop: `${marginTop}px` }}
                    >
                      <Link
                        to="Collapse"
                        spy={true}

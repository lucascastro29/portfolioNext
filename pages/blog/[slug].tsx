          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                <p className="text-sm font-medium text-white">{post.author?.name ?? "Autor"}</p>
                {post.date && (
          ...
          <div className="led-sign section-panel blog-post-footer">
            <div className="grid gap-4 md:grid-cols-12">
              <section className="rounded-xl border border-cyan-200/20 bg-slate-950/35 p-4 md:col-span-7">
                ...
                {toc.length === 0 ? (
                  <p className="mt-3 mb-0 text-sm text-cyan-100/70">No hay subtítulos detectados.</p>
                ) : (
              ...
              <section className="rounded-xl border border-cyan-200/20 bg-slate-950/35 p-4 md:col-span-2">
                <p className="m-0 text-xs font-semibold uppercase tracking-[0.18em] text-cyan-200">Tiempo de Lectura</p>
                <p className="mt-3 mb-0 text-base font-semibold text-cyan-50">~{readingMinutes} min</p>
                <p className="mt-1 mb-0 text-xs text-cyan-100/65">Estimado automáticamente</p>
              </section>
